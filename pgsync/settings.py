...
PG_TABLE_TRANSACTIONAL_CONSISTENCY=env.bool("PG_DB_TRANSACTIONAL_CONSISTENCY", default=True)
PG_DB_TRANSACTIONAL_CONSISTENCY=env.bool("PG_TABLE_TRANSACTIONAL_CONSISTENCY", default=True)
